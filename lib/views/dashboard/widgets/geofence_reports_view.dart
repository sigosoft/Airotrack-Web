...
import 'geofence_detail_map_view.dart';

class GeofenceReportsView extends StatefulWidget {
  const GeofenceReportsView({super.key});

  @override
  State<GeofenceReportsView> createState() => _GeofenceReportsViewState();
}
...
class _GeofenceReportsViewState extends State<GeofenceReportsView> {
  ...
  Widget _buildGeofenceCard(Map<String, dynamic> item) {
    final bool isEnter = item['isEnter'] ?? true;
    final Color iconColor = isEnter ? const Color(0xFF12B76A) : const Color(0xFFF04438);
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                // Row 1: Red Car Icon + Vehicle Number + Geofence Event Icon/Label
                Row(
                  children: [
                    Image.asset(
                      AppAssets.carImage,
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () {
                Get.to(() => GeofenceDetailMapView(reportData: item));
              },
              child: Container(
                width: 32,
                height: 28,
