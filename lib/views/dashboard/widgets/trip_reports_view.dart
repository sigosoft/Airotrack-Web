...
class TripReportsView extends StatefulWidget {
  const TripReportsView({super.key});

  @override
  State<TripReportsView> createState() => _TripReportsViewState();
}
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                // Row 1: Blue Car Icon + Vehicle Number + Duration
                Row(
                  children: [
                    Image.asset(
                      AppAssets.carImage,
                ...
                // Row 3: Green Start Clock & Red End Clock Timestamps
                Row(
                  children: [
                    const Icon(
                ...
                // Row 4: Green Circle Dot + Start Location Address
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Padding(
                ...
                // Row 5: Red Circle Dot + End Location Address
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Padding(
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () {
                Get.to(() => TripDetailMapView(reportData: item));
              },
              child: Container(
                width: 32,
                height: 28,
