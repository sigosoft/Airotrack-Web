...
import 'over_speed_detail_map_view.dart';

class OverSpeedReportsView extends StatefulWidget {
  const OverSpeedReportsView({super.key});

  @override
  State<OverSpeedReportsView> createState() => _OverSpeedReportsViewState();
}
...
class _OverSpeedReportsViewState extends State<OverSpeedReportsView> {
  ...
  Widget _buildOverSpeedCard(Map<String, dynamic> item) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                // Row 1: Red Car Icon + Vehicle Number + Speed Metric
                Row(
                  children: [
                    Image.asset(
                      AppAssets.carImage,
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () {
                Get.to(() => OverSpeedDetailMapView(reportData: item));
              },
              child: Container(
                width: 32,
                height: 28,
