...
import 'ignition_detail_map_view.dart';

class IgnitionReportsView extends StatefulWidget {
  const IgnitionReportsView({super.key});

  @override
  State<IgnitionReportsView> createState() => _IgnitionReportsViewState();
}
        ...
        children: [
          Padding(
            ...
            child: Column(
              ...
              children: [
                // Row 1: Red Car Icon + Vehicle Number + Status Badge
                Row(
                  children: [
                    Image.asset(
                      AppAssets.carImage,
          ...
          Positioned(
            ...
            child: InkWell(
              onTap: () {
                Get.to(() => IgnitionDetailMapView(reportData: item));
              },
              child: Container(
                width: 32,
                height: 28,
