...
class SummaryReportsView extends StatefulWidget {
  const SummaryReportsView({super.key});

  @override
  State<SummaryReportsView> createState() => _SummaryReportsViewState();
}

class _SummaryReportsViewState extends State<SummaryReportsView> {
  int _selectedPage = 1;

  final List<Map<String, dynamic>> _summaryReportsList = [
    {
      ...
      'stoped': '00:38:41h',
      'idle': '00:38:41h',
      'startLocation': 'PuthiyakavuJunction,Karunagappalli, Kerala 690539, India',
      'endLocation': 'PuthiyakavuJunction,Karunagappalli, Kerala 690539, India',
      'startOdo': '0535855KM',
      'endOdo': '0535855KM',
      'avgSpeed': '25.10 kmph',
      'maxSpeed': '52.10 kmph',
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        return GridView.builder(
                          ...
                          itemCount: _summaryReportsList.length,
                          gridDelegate:
                              SliverGridDelegateWithFixedCrossAxisCount(
                            crossAxisCount: crossAxisCount,
                            crossAxisSpacing: 16,
                            mainAxisSpacing: 16,
                            mainAxisExtent: maxWidth < 850 ? 205 : 180,
                          ),
                          itemBuilder: (context, index) {
                            final item = _summaryReportsList[index];
                    ...
                    if ((_summaryReportsList.length / 10).ceil() > 1)
                      FittedBox(
                        fit: BoxFit.scaleDown,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            for (int i = 1; i <= (_summaryReportsList.length / 10).ceil(); i++) ...[
                              InkWell(
                                onTap: () {
                                  setState(() {
                                    _selectedPage = i;
                            ...
                            // NEXT Button
                            if (_selectedPage < (_summaryReportsList.length / 10).ceil())
                              InkWell(
                                onTap: () {
                                  if (_selectedPage < (_summaryReportsList.length / 10).ceil()) {
                                    setState(() {
  ...
  Widget _buildSummaryCard(Map<String, dynamic> item) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Section 1: Vehicle Number + Location Pin Distance Metric
          Row(
            children: [
            Image.asset(
              AppAssets.carImage,
          ...
          // Section 2: 4 Metrics Grid (Engine Hour, Running, Stoped, Idle)
          Row(
          ...
          // Section 3: Locations & Odometer Pills Timeline
          Column(
            children: [
              // Start Location
              Row(
          ...
          // Section 4: Speed Metrics Bottom Row (Avg Speed & Max Speed)
          FittedBox(
            fit: BoxFit.scaleDown,
            alignment: Alignment.center,
            child: Row(
