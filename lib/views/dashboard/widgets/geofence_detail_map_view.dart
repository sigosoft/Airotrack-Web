...
class GeofenceDetailMapView extends StatefulWidget {
  ...
  const GeofenceDetailMapView({
    super.key,
    this.reportData,
  });

  @override
  State<GeofenceDetailMapView> createState() => _GeofenceDetailMapViewState();
}

class _GeofenceDetailMapViewState extends State<GeofenceDetailMapView> {
  ...
  Widget build(BuildContext context) {
    ...
    final addressStr = widget.reportData?['location']?.toString() ??
        ...
        widget.reportData?['geofence_name']?.toString() ??
        '-';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // 1. Top Navigation Bar with Back Arrow & 'Geofence' Title
          Container(
            height: 52,
