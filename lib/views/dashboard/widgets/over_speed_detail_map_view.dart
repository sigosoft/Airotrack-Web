...
class OverSpeedDetailMapView extends StatefulWidget {
  final Map<String, dynamic>? reportData;

  const OverSpeedDetailMapView({
    super.key,
    this.reportData,
  });

  @override
  State<OverSpeedDetailMapView> createState() => _OverSpeedDetailMapViewState();
}

class _OverSpeedDetailMapViewState extends State<OverSpeedDetailMapView> {
  ...
  Widget build(BuildContext context) {
    ...
    final timestamp = widget.reportData?['timestamp'] ??
        ...
        '-';
    final speed = widget.reportData?['speed'] ??
        widget.reportData?['top_speed'] ??
        widget.reportData?['max_speed'] ??
        '-';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // 1. Top Navigation Bar with Back Arrow & 'Over Speed' Title
          Container(
            height: 52,
